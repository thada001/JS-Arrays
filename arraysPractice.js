...
//Above you're given a function that will return a random number between 0 and 30, and an array full 
//of numbers. Your job is to write a function named finder that will get a random number, then loop
// through the array to see if that random number is in the array. If it is, return true, if it's 
//not, return false
...
var finder = function(numbers) {
  var rndm = getRandomArbitrary();
  if (numbers.indexOf(rndm) !== -1) {
    return true;
  }else {
    return false;
  }
...
var user2 = {
    name: 'Tom Adair',
    email: 'thomascadair@comcast.net',
    password: 'angular',
    username: 'thada001',
};
var user3 = {
    name: 'Keah Adair',
    email: 'keahadair@comcast.net',
    password: 'poop',
    username: 'keeks',
};
var user4 = {
    name: 'Jordan Adair',
    email: 'jadair@comcast.net',
    password: 'arsenal',
    username: 'jordair',
};
users.push(user1);
